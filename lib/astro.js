...
async function syncdb() {
  let thumbnailImagePath = __dirname + "/assets/Toxic.jpeg";
  ...
  try {
    ...
    thumbnailImagePath = __dirname + "/assets/Toxic.jpeg";
  }
  global.log0 =
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "Toxic-Md-V1"],
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /254735342808|254799283147|17863688449/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "Toxic-Md-V1") +
        "\n";
      try {
  ...
  AstaConn.messageId = (length = 8, prefix = "Toxic-Md-V2") => {
...
app.listen(randomPort, () =>
  console.log(
    "Toxic-Md--V1 Server listening on http://localhost:" + randomPort + "/ "
  )
);
